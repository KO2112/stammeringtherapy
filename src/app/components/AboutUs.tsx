    ...
    <section className="py-24 bg-gradient-to-b from-blue-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-sm font-semibold text-blue-600 uppercase tracking-wide">Biz Kimiz</h2>
          <h2 className="mt-2 text-3xl md:text-4xl font-bold text-gray-900 leading-tight">Hakkımızda</h2>
          <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
            Teknoloji ve kişiselleştirilmiş terapi aracılığıyla insanların kekemelik zorluklarını aşmalarına yardımcı olmaya adanmış işbirlikçi uzman ekibi.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-blue-500">
                ...
                <p className="text-gray-700 mt-2">Yılların Birleşik Deneyimi</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-blue-500">
                <div className="text-3xl font-bold text-blue-600">3</div>
                <p className="text-gray-700 mt-2">Dünya Çapında Bölge</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-blue-500">
                <div className="text-3xl font-bold text-blue-600">10000+</div>
                <p className="text-gray-700 mt-2">Yardım Edilen Kekemeler</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-blue-500">
                <div className="text-3xl font-bold text-blue-600">%100</div>
                <p className="text-gray-700 mt-2">Kanıta Dayalı Yöntemler</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 mt-8">
              <h4 className="text-xl font-medium text-blue-800 mb-4">İki Yönlü Yaklaşımımız</h4>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h5 className="text-lg font-medium text-gray-900">E-Kekemelik Uygulaması</h5>
                    <p className="mt-1 text-gray-700">Kendi kendine rehberli terapi için egzersizler, teknikler ve ilerleme takibi sağlayan kapsamlı dijital platform.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h5 className="text-lg font-medium text-gray-900">Özel Terapi Seansları</h5>
                    <p className="mt-1 text-gray-700">Özel ihtiyaçlarınız ve zorluklarınıza göre uyarlanmış sertifikalı uzmanlarla kişiselleştirilmiş bire bir seanslar.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-20 bg-blue-600 rounded-2xl shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-10 md:p-12">
              <h3 className="text-2xl font-bold text-white mb-4">Yolculuğunuza Bugün Başlayın</h3>
              <p className="text-blue-100 text-lg mb-6">
                Uygulamamız veya kişiselleştirilmiş terapi seanslarımız aracılığıyla, ekibimiz akıcı ve kendinden emin konuşma elde etmenize yardımcı olmaya hazır.
              </p>
