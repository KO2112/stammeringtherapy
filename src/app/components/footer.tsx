          ...
          <div>
            ...
            <div className="space-y-1 text-sm">
              <p className="flex items-center">
                ...
                <span>0 (232) 421 51 45</span>
              </p>
              <p className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2 text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>info@armonikekemeliktedavisi.com</span>
              </p>
            </div>
          </div>
...
<div>
  ...
  <div className="mt-2 flex space-x-3">
    <a href="https://www.facebook.com/armonikekemeliktedavisi" target="_blank" className="text-blue-300 hover:text-white">
      <span className="sr-only">Facebook</span>
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
      </svg>
    </a>
    <a href="https://x.com/armonikekemelik" target="_blank" className="text-blue-300 hover:text-white">
      <span className="sr-only">Twitter</span>
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
      </svg>
    </a>
    <a href="https://www.instagram.com/armoni_dilkonusma/" target="_blank" className="text-blue-300 hover:text-white">
    ...
    <a href="https://www.youtube.com/channel/UCXb3uyDjRtTipQs8Dtf7GSw" target="_blank" className="text-blue-300 hover:text-white">
  <span className="sr-only">YouTube</span>
  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    <path d="M23.498 6.186a2.956 2.956 0 00-2.08-2.08C19.692 3.5 12 3.5 12 3.5s-7.692 0-9.418.606a2.956 2.956 0 00-2.08 2.08C.5 7.912.5 12 .5 12s0 4.088.606 5.814a2.956 2.956 0 002.08 2.08C4.308 20.5 12 20.5 12 20.5s7.692 0 9.418-.606a2.956 2.956 0 002.08-2.08C23.5 16.088 23.5 12 23.5 12s0-4.088-.002-5.814zM9.75 15.02V8.98l6.25 3.02-6.25 3.02z"/>
  </svg>
</a>
  </div>
</div>
        ...
        <div className="border-t border-gray-700 mt-4 pt-4 text-center text-gray-400 text-sm">
          <p>© 2025 Armoni. Tüm Hakları Saklıdır.</p>
        </div>
      </div>
    </footer>
  );
