...
export default function KirZincirleriniPage() {
  ...
  const textSegments: TextSegment[] = [
    ...
    { text: "muş", duration: 0.9, begin: 9.308, index: 26 },
    { text: " i", duration: 0.7, begin: 10.608, index: 27 },
    ...
    { text: " za", duration: 0.98, begin: 70.99, index: 172 },
    ...
    { text: "le", duration: 0.98, begin: 78.99, index: 190 },
    { text: "rin", duration: 0.98, begin: 79.108, index: 191 },
    { text: " yap", duration: 0.98, begin: 80.25, index: 192 },
    { text: "tı", duration: 0.98, begin: 80.5, index: 193 },
    ...
    { text: "yi", duration: 0.98, begin: 83.25, index: 198 },
    { text: " ya", duration: 0.98, begin: 83.5, index: 199 },
    { text: "da", duration: 0.98, begin: 83.75, index: 200 },
    { text: " kö", duration: 0.98, begin: 83.95, index: 201 },
    { text: "tü", duration: 0.98, begin: 84.25, index: 202 },
    { text: " ol", duration: 0.98, begin: 84.5, index: 203 },
    { text: "du", duration: 0.98, begin: 84.75, index: 204 },
    { text: "ğu", duration: 0.98, begin: 84.95, index: 205 },
    { text: "nu", duration: 0.98, begin: 85.25, index: 206 },
    { text: " an", duration: 0.98, begin: 86.2, index: 207 },
    { text: "cak", duration: 0.98, begin: 86.4, index: 208 },
    { text: " sen", duration: 0.98, begin: 87.55, index: 209 },
    { text: " git", duration: 0.98, begin: 87.75, index: 210 },
    { text: "tik", duration: 0.98, begin: 87.95, index: 211 },
    { text: "ten", duration: 0.98, begin: 88.808, index: 212 },
    { text: " son", duration: 0.98, begin: 89.15, index: 213 },
    { text: "ra", duration: 0.98, begin: 89.35, index: 214 },
    { text: " an", duration: 0.98, begin: 89.55, index: 215 },
    { text: "la", duration: 0.98, begin: 89.85, index: 216 },
    { text: "ya", duration: 0.98, begin: 90.15, index: 217 },
    { text: "bi", duration: 0.98, begin: 90.3, index: 218 },
    { text: "le", duration: 0.98, begin: 90.6, index: 219 },
    { text: "cek", duration: 0.98, begin: 90.808, index: 220 },
    { text: "ler", duration: 0.98, begin: 91.208, index: 221 },
    { text: " di", duration: 0.98, begin: 92.5, index: 222 },
    { text: "ye", duration: 0.98, begin: 92.8, index: 223 },
    { text: " de", duration: 0.98, begin: 93.15, index: 224 },
    { text: "vam", duration: 0.98, begin: 93.3, index: 225 },
    { text: " et", duration: 0.98, begin: 93.6, index: 226 },
    { text: "ti", duration: 0.98, begin: 93.85, index: 227 },
    { text: " de", duration: 0.98, begin: 94.15, index: 228 },
    { text: "li", duration: 0.98, begin: 94.3, index: 229 },
    { text: "kan", duration: 0.98, begin: 94.6, index: 230 },
    { text: "lı.", duration: 0.98, begin: 94.85, index: 231 },
    { text: " Şem", duration: 0.98, begin: 96.5, index: 232 },
    { text: "si", duration: 0.98, begin: 96.75, index: 233 },
    { text: "ye", duration: 0.98, begin: 97.1, index: 234 },
    { text: " Ta", duration: 0.98, begin: 97.35, index: 235 },
    { text: "mir", duration: 0.98, begin: 97.6, index: 236 },
    { text: "ci", duration: 0.98, begin: 97.85, index: 237 },
    { text: "si:", duration: 0.98, begin: 98.1, index: 238 },
    { text: " E", duration: 0.98, begin: 99.2, index: 239 },
    { text: "vet", duration: 0.98, begin: 99.45, index: 240 },
    { text: " hak", duration: 0.98, begin: 99.7, index: 241 },
    { text: "lı", duration: 0.98, begin: 99.95, index: 242 },
    { text: "sın.", duration: 0.98, begin: 100.2, index: 243 },
    { text: " Genç:", duration: 0.98, begin: 102.25, index: 244 },
    { text: " Bu", duration: 0.98, begin: 103.25, index: 245 },
    { text: " ta", duration: 0.98, begin: 103.5, index: 246 },
    { text: "ra", duration: 0.98, begin: 103.75, index: 247 },
    { text: "fa", duration: 0.98, begin: 104.0, index: 248 },
    { text: " tek", duration: 0.98, begin: 104.25, index: 249 },
    { text: "rar", duration: 0.98, begin: 104.5, index: 250 },
    { text: " ge", duration: 0.98, begin: 104.75, index: 251 },
    { text: "le", duration: 0.98, begin: 105.0, index: 252 },
    { text: "cek", duration: 0.98, begin: 105.25, index: 253 },
    { text: " mi", duration: 0.98, begin: 105.5, index: 254 },
    { text: "si", duration: 0.98, begin: 105.75, index: 255 },
    { text: "niz?", duration: 0.98, begin: 106.0, index: 256 },
    { text: " Şem", duration: 0.98, begin: 107.5, index: 257 },
    { text: "si", duration: 0.98, begin: 107.75, index: 258 },
    { text: "ye", duration: 0.98, begin: 108.0, index: 259 },
    { text: " Ta", duration: 0.98, begin: 108.25, index: 260 },
    { text: "mir", duration: 0.98, begin: 108.5, index: 261 },
    { text: "ci", duration: 0.98, begin: 108.75, index: 262 },
    { text: "si:", duration: 0.98, begin: 109.0, index: 263 },
    { text: " Ha", duration: 0.78, begin: 110.5, index: 264 },
    { text: "yır.", duration: 0.98, begin: 110.75, index: 265 },
    { text: " Genç:", duration: 0.98, begin: 112.5, index: 266 },
    { text: " O", duration: 0.98, begin: 113.25, index: 267 },
    { text: " hal", duration: 0.98, begin: 113.35, index: 268 },
    { text: "de", duration: 0.98, begin: 113.75, index: 269 },
    { text: " bir", duration: 0.98, begin: 114.85, index: 270 },
    { text: " şem", duration: 0.98, begin: 115.0, index: 271 },
    { text: "si", duration: 0.98, begin: 115.25, index: 272 },
    { text: "ye", duration: 0.98, begin: 115.5, index: 273 },
    { text: " i", duration: 0.98, begin: 115.85, index: 274 },
    { text: "çin", duration: 0.98, begin: 116.0, index: 275 },
    { text: " ne", duration: 0.78, begin: 117.45, index: 276 },
    { text: "den", duration: 0.78, begin: 117.65, index: 277 },
    { text: " bu", duration: 0.78, begin: 117.95, index: 278 },
    { text: " ka", duration: 0.78, begin: 118.0, index: 279 },
    { text: "dar", duration: 0.78, begin: 118.25, index: 280 },
    { text: " uğ", duration: 0.98, begin: 118.5, index: 281 },
    { text: "ra", duration: 0.98, begin: 118.75, index: 282 },
    { text: "şı", duration: 0.98, begin: 119.0, index: 283 },
    { text: "yor", duration: 0.98, begin: 119.25, index: 284 },
    { text: "su", duration: 0.98, begin: 119.5, index: 285 },
    { text: "nuz?", duration: 0.98, begin: 119.75, index: 286 },
    { text: " Hal", duration: 0.78, begin: 121.85, index: 287 },
    { text: " bu", duration: 0.78, begin: 122.0, index: 288 },
    { text: " ki", duration: 0.78, begin: 123.0, index: 289 },
    { text: " i", duration: 0.78, begin: 123.25, index: 290 },
    { text: "şi", duration: 0.78, begin: 123.5, index: 291 },
    { text: "ni", duration: 0.78, begin: 123.75, index: 292 },
    { text: "zi", duration: 0.78, begin: 124.0, index: 293 },
    { text: " ça", duration: 0.78, begin: 124.45, index: 294 },
    { text: "bu", duration: 0.78, begin: 124.55, index: 295 },
    { text: "cak", duration: 0.78, begin: 124.75, index: 296 },
    { text: " hal", duration: 0.78, begin: 125.0, index: 297 },
    { text: "le", duration: 0.78, begin: 125.25, index: 298 },
    { text: "dip", duration: 0.78, begin: 125.5, index: 299 },
    { text: " i", duration: 0.78, begin: 126.55, index: 300 },
    { text: "le", duration: 0.78, begin: 126.75, index: 301 },
    { text: "ri", duration: 0.78, begin: 127.0, index: 302 },
    { text: " de", duration: 0.78, begin: 127.25, index: 303 },
    { text: " ye", duration: 0.48, begin: 128.35, index: 304 },
    { text: "ni", duration: 0.53, begin: 128.55, index: 305 },
    { text: " müş", duration: 0.53, begin: 129.0, index: 306 },
    { text: "te", duration: 0.53, begin: 129.25, index: 307 },
    { text: "ri", duration: 0.53, begin: 129.5, index: 308 },
    { text: "ler", duration: 0.53, begin: 129.75, index: 309 },
    { text: " bu", duration: 0.53, begin: 130.0, index: 310 },
    { text: "la", duration: 0.53, begin: 130.25, index: 311 },
    { text: "bi", duration: 0.53, begin: 130.5, index: 312 },
    { text: "lir", duration: 0.53, begin: 130.75, index: 313 },
    { text: "si", duration: 0.53, begin: 131.0, index: 314 },
    { text: "niz.", duration: 0.53, begin: 131.25, index: 315 },
    { text: " Çok", duration: 0.98, begin: 132.5, index: 316 },
    { text: " faz", duration: 0.98, begin: 132.75, index: 317 },
    { text: "la", duration: 0.98, begin: 133.0, index: 318 },
    { text: " ko", duration: 0.53, begin: 134.75, index: 319 },
    { text: "nuş", duration: 0.53, begin: 135.0, index: 320 },
    { text: "ma", duration: 0.53, begin: 135.25, index: 321 },
    { text: "yı", duration: 0.53, begin: 135.5, index: 322 },
    { text: " sev", duration: 0.53, begin: 135.75, index: 323 },
    { text: "me", duration: 0.53, begin: 136.0, index: 324 },
    { text: "yen", duration: 0.53, begin: 136.25, index: 325 },
    { text: " şem", duration: 0.53, begin: 137.5, index: 326 },
    { text: "si", duration: 0.53, begin: 137.75, index: 327 },
    { text: "ye", duration: 0.53, begin: 138.0, index: 328 },
    { text: " ta", duration: 0.53, begin: 138.25, index: 329 },
    { text: "mir", duration: 0.53, begin: 138.5, index: 330 },
    { text: "ci", duration: 0.53, begin: 138.75, index: 331 },
    { text: "si", duration: 0.53, begin: 139.0, index: 332 },
    { text: " gen", duration: 0.53, begin: 140.25, index: 333 },
    { text: "ce", duration: 0.53, begin: 140.5, index: 334 },
    { text: " ders", duration: 0.53, begin: 140.75, index: 335 },
    { text: " ni", duration: 0.53, begin: 141.0, index: 336 },
    { text: "te", duration: 0.53, begin: 141.25, index: 337 },
    { text: "li", duration: 0.53, begin: 141.5, index: 338 },
    { text: "ğin", duration: 0.53, begin: 141.75, index: 339 },
    { text: "de", duration: 0.53, begin: 142.0, index: 340 },
    { text: " şu", duration: 0.53, begin: 143.25, index: 341 },
    { text: " ce", duration: 0.53, begin: 143.5, index: 342 },
    { text: "va", duration: 0.53, begin: 143.75, index: 343 },
    { text: "bı", duration: 0.53, begin: 144.0, index: 344 },
    { text: " ver", duration: 0.53, begin: 144.25, index: 345 },
    { text: "di:", duration: 0.53, begin: 144.5, index: 346 },
    { text: " E", duration: 0.53, begin: 146.5, index: 347 },
    { text: "ğer", duration: 0.53, begin: 146.75, index: 348 },
    { text: " ben", duration: 0.53, begin: 147.0, index: 349 },
    { text: " i", duration: 0.53, begin: 148.25, index: 350 },
    { text: "şi", duration: 0.53, begin: 148.5, index: 351 },
    { text: "mi", duration: 0.53, begin: 148.75, index: 352 },
    { text: " i", duration: 0.53, begin: 149.0, index: 353 },
    { text: "yi", duration: 0.53, begin: 149.25, index: 354 },
    { text: " ya", duration: 0.53, begin: 149.5, index: 355 },
    { text: "par", duration: 0.53, begin: 149.75, index: 356 },
    { text: "sam,", duration: 0.53, begin: 150.0, index: 357 },
    { text: " ben", duration: 0.53, begin: 151.0, index: 358 },
    { text: "den", duration: 0.53, begin: 151.25, index: 359 },
    { text: " son", duration: 0.53, begin: 152.25, index: 360 },
    { text: "ra", duration: 0.53, begin: 152.5, index: 361 },
    { text: " bu", duration: 0.53, begin: 153.25, index: 362 },
    { text: "ra", duration: 0.53, begin: 153.5, index: 363 },
    { text: "dan", duration: 0.53, begin: 153.75, index: 364 },
    { text: " ge", duration: 0.53, begin: 154.5, index: 365 },
    { text: "çe", duration: 0.53, begin: 154.75, index: 366 },
    { text: "cek", duration: 0.53, begin: 155.0, index: 367 },
    { text: " ta", duration: 0.53, begin: 155.5, index: 368 },
    { text: "mir", duration: 0.53, begin: 155.75, index: 369 },
    { text: "ci", duration: 0.53, begin: 156.0, index: 370 },
    { text: "nin", duration: 0.53, begin: 156.25, index: 371 },
    { text: " i", duration: 0.53, begin: 157.25, index: 372 },
    { text: "şi", duration: 0.53, begin: 157.5, index: 373 },
    { text: " ko", duration: 0.53, begin: 157.75, index: 374 },
    { text: "lay", duration: 0.53, begin: 158.0, index: 375 },
    { text: "la", duration: 0.53, begin: 158.25, index: 376 },
    { text: "şa", duration: 0.53, begin: 158.5, index: 377 },
    { text: "cak.", duration: 0.53, begin: 158.75, index: 378 },
    { text: " Fa", duration: 0.53, begin: 160.25, index: 379 },
    { text: "kat", duration: 0.53, begin: 160.5, index: 380 },
    { text: " kö", duration: 0.53, begin: 161.5, index: 381 },
    { text: "tü", duration: 0.53, begin: 161.75, index: 382 },
    { text: " mal", duration: 0.53, begin: 162.25, index: 383 },
    { text: "ze", duration: 0.53, begin: 162.5, index: 384 },
    { text: "me", duration: 0.53, begin: 162.75, index: 385 },
    { text: " kul", duration: 0.53, begin: 163.0, index: 386 },
    { text: "la", duration: 0.53, begin: 163.25, index: 387 },
    { text: "nır", duration: 0.53, begin: 163.5, index: 388 },
    { text: " ve", duration: 0.53, begin: 163.75, index: 389 },
    { text: " baş", duration: 0.53, begin: 165.5, index: 390 },
    { text: "tan", duration: 0.53, begin: 165.75, index: 391 },
    { text: " sav", duration: 0.53, begin: 166.0, index: 392 },
    { text: "ma", duration: 0.53, begin: 166.25, index: 393 },
    { text: " bir", duration: 0.53, begin: 167.25, index: 394 },
    { text: " iş", duration: 0.53, begin: 167.5, index: 395 },
    { text: " çı", duration: 0.53, begin: 167.75, index: 396 },
    { text: "ka", duration: 0.53, begin: 168.0, index: 397 },
    { text: "rır", duration: 0.53, begin: 168.25, index: 398 },
    { text: "sam,", duration: 0.53, begin: 168.5, index: 399 },
    { text: " halk", duration: 0.53, begin: 170.0, index: 400 },
    { text: " bu", duration: 0.53, begin: 170.25, index: 401 },
    { text: "nu", duration: 0.53, begin: 170.5, index: 402 },
    { text: " er", duration: 0.53, begin: 171.75, index: 403 },
    { text: " ya", duration: 0.53, begin: 172.0, index: 404 },
    { text: "da", duration: 0.53, begin: 172.25, index: 405 },
    { text: " geç", duration: 0.53, begin: 172.5, index: 406 },
    { text: " an", duration: 0.53, begin: 172.75, index: 407 },
    { text: "la", duration: 0.53, begin: 173.0, index: 408 },
    { text: "ya", duration: 0.53, begin: 173.25, index: 409 },
    { text: "cak", duration: 0.53, begin: 173.5, index: 410 },
    { text: " ve", duration: 0.53, begin: 175.0, index: 411 },
    { text: " da", duration: 0.53, begin: 175.25, index: 412 },
    { text: "ha", duration: 0.53, begin: 175.5, index: 413 },
    { text: " son", duration: 0.53, begin: 175.75, index: 414 },
    { text: "ra", duration: 0.53, begin: 176.0, index: 415 },
    { text: " bu", duration: 0.53, begin: 177.25, index: 416 },
    { text: "ra", duration: 0.53, begin: 177.5, index: 417 },
    { text: "dan", duration: 0.53, begin: 177.75, index: 418 },
    { text: " ge", duration: 0.53, begin: 178.0, index: 419 },
    { text: "çe", duration: 0.53, begin: 178.25, index: 420 },
    { text: "cek", duration: 0.53, begin: 178.5, index: 421 },
    { text: " o", duration: 0.53, begin: 178.75, index: 422 },
    { text: "lan", duration: 0.53, begin: 179.0, index: 423 },
    { text: " ta", duration: 0.53, begin: 180.5, index: 424 },
    { text: "mir", duration: 0.53, begin: 180.75, index: 425 },
    { text: "ci", duration: 0.53, begin: 181.0, index: 426 },
    { text: "ye", duration: 0.53, begin: 181.25, index: 427 },
    { text: " iş", duration: 0.98, begin: 181.5, index: 428 },
    { text: " ver", duration: 0.98, begin: 181.75, index: 429 },
    { text: "me", duration: 0.98, begin: 182.0, index: 430 },
    { text: "ye", duration: 0.98, begin: 182.25, index: 431 },
    { text: "cek", duration: 0.98, begin: 182.5, index: 432 },
    { text: "tir.", duration: 0.98, begin: 182.75, index: 433 },
  ];
