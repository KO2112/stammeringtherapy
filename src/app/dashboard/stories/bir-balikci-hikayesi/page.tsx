...
export default function KirZincirleriniPage() {
  ...
  const textSegments: TextSegment[] = [
    ...
    { text: "ha", duration: 0.68, begin: 29.7, index: 75 },
    ...
    { text: "ki", duration: 0.78, begin: 40.15, index: 100 },
    ...
    { text: "miş", duration: 0.58, begin: 43.21, index: 108 },
    { text: " ba", duration: 0.98, begin: 43.35, index: 109 },
    ...
    { text: "tah", duration: 0.98, begin: 45.25, index: 113 },
    ...
    { text: " bi", duration: 0.98, begin: 50.85, index: 125 },
    { text: "raz", duration: 0.98, begin: 51.0, index: 126 },
    { text: " da", duration: 0.98, begin: 51.308, index: 127 },
    { text: "ha", duration: 0.98, begin: 51.508, index: 128 },
    { text: " ka", duration: 0.98, begin: 52.0, index: 129 },
    ...
    { text: " di", duration: 0.98, begin: 57.3, index: 141 },
    { text: "ye", duration: 0.98, begin: 57.38, index: 142 },
    { text: " sor", duration: 0.98, begin: 57.608, index: 143 },
    { text: "muş.", duration: 0.98, begin: 57.908, index: 144 },
    { text: " Bu", duration: 0.78, begin: 59.75, index: 145 },
    { text: " ka", duration: 0.98, begin: 59.85, index: 146 },
    { text: "da", duration: 0.98, begin: 59.99, index: 147 },
    { text: "rı", duration: 0.98, begin: 60.25, index: 148 },
    { text: " bi", duration: 0.78, begin: 60.55, index: 149 },
    { text: "ze", duration: 0.78, begin: 60.85, index: 150 },
    { text: " ye", duration: 0.78, begin: 61.35, index: 151 },
    { text: "ti", duration: 0.78, begin: 61.5, index: 152 },
    { text: "yor", duration: 0.78, begin: 61.68, index: 153 },
    { text: " da", duration: 0.98, begin: 61.85, index: 154 },
    { text: " on", duration: 0.48, begin: 62.95, index: 155 },
    { text: "dan", duration: 0.68, begin: 63.0, index: 156 },
    { text: " di", duration: 0.68, begin: 64.0, index: 157 },
    { text: "ye", duration: 0.68, begin: 64.45, index: 158 },
    { text: " o", duration: 0.68, begin: 64.85, index: 159 },
    { text: "muz", duration: 0.68, begin: 64.95, index: 160 },
    { text: " silk", duration: 0.68, begin: 65.1, index: 161 },
    { text: "miş", duration: 0.68, begin: 65.25, index: 162 },
    { text: " ba", duration: 0.48, begin: 66.35, index: 163 },
    { text: "lık", duration: 0.48, begin: 66.45, index: 164 },
    { text: "çı.", duration: 0.48, begin: 66.55, index: 165 },
    { text: " Şaş", duration: 0.98, begin: 68.0, index: 166 },
    { text: "mış", duration: 0.98, begin: 68.4, index: 167 },
    { text: " ba", duration: 0.98, begin: 68.508, index: 168 },
    { text: "lık", duration: 0.98, begin: 68.85, index: 169 },
    { text: "çı", duration: 0.98, begin: 68.999, index: 170 },
    { text: "nın", duration: 0.98, begin: 69.218, index: 171 },
    { text: " bu", duration: 0.48, begin: 70.45, index: 172 },
    { text: " ka", duration: 0.83, begin: 70.55, index: 173 },
    ...
    { text: "da", duration: 0.48, begin: 73.55, index: 182 },
    { text: "mı;", duration: 0.68, begin: 73.85, index: 183 },
    ...
    { text: "ki", duration: 0.98, begin: 78.75, index: 197 },
    { text: " di", duration: 0.48, begin: 79.95, index: 198 },
    { text: "ye", duration: 0.98, begin: 79.999, index: 199 },
    { text: " üs", duration: 0.98, begin: 80.25, index: 200 },
    { text: "te", duration: 0.98, begin: 80.48, index: 201 },
    ...
    { text: " i", duration: 0.78, begin: 109.51, index: 271 },
    { text: "çer,", duration: 0.78, begin: 109.53, index: 272 },
    { text: " geç", duration: 0.78, begin: 111.508, index: 273 },
    { text: " vak", duration: 0.78, begin: 111.99, index: 274 },
    ...
    { text: " meş", duration: 0.6, begin: 117.2, index: 285 },
    ...
    { text: " Ben", duration: 0.58, begin: 125.59, index: 301 },
    { text: " sa", duration: 0.68, begin: 125.6, index: 302 },
    { text: "na", duration: 0.78, begin: 125.68, index: 303 },
    ...
    { text: " Bu", duration: 0.78, begin: 130.05, index: 312 },
    { text: " i", duration: 0.78, begin: 130.12, index: 313 },
    { text: "şe", duration: 0.78, begin: 130.208, index: 314 },
    { text: " da", duration: 0.78, begin: 131.398, index: 315 },
    { text: "ha", duration: 0.78, begin: 131.41, index: 316 },
    ...
    { text: "yük", duration: 0.78, begin: 135.95, index: 328 },
    ...
    { text: "ha", duration: 0.78, begin: 147.99, index: 356 },
    ...
    { text: " Kı", duration: 0.78, begin: 150.99, index: 365 },
    ...
    { text: "de", duration: 0.9, begin: 152.708, index: 369 },
    ...
    { text: "hip", duration: 0.78, begin: 157.11, index: 379 },
    ...
    { text: "lı", duration: 0.78, begin: 162.9, index: 392 },
    ...
    { text: " de", duration: 0.78, begin: 164.95, index: 399 },
    { text: "ğil,", duration: 0.78, begin: 165.12, index: 400 },
    { text: " doğ", duration: 0.78, begin: 166.608, index: 401 },
    { text: "ru", duration: 0.78, begin: 166.808, index: 402 },
    { text: "dan", duration: 0.78, begin: 166.99, index: 403 },
    ...
    { text: " za", duration: 0.78, begin: 174.45, index: 417 },
    ...
    { text: "ri", duration: 0.58, begin: 177.99, index: 425 },
    ...
    { text: "rün", duration: 0.78, begin: 185.99, index: 446 },
    ...
    { text: " o", duration: 0.78, begin: 188.88, index: 452 },
    ...
    { text: "lık", duration: 0.78, begin: 190.99, index: 456 },
    ...
    { text: "rı", duration: 0.78, begin: 193.99, index: 463 },
    ...
    { text: "ne", duration: 0.78, begin: 195.99, index: 468 },
    ...
    { text: " muş.", duration: 0.78, begin: 198.99, index: 476 },
    ...
    { text: "da", duration: 0.78, begin: 203.99, index: 482 },
    ...
    { text: "lak;", duration: 0.78, begin: 209.99, index: 497 },
    ...
    { text: "ka", duration: 0.78, begin: 215.85, index: 509 },
    { text: " a", duration: 0.78, begin: 216.15, index: 510 },
    { text: "çar", duration: 0.78, begin: 216.35, index: 511 },
    { text: "sın,", duration: 0.78, begin: 216.45, index: 512 },
    { text: " his", duration: 0.78, begin: 217.99, index: 513 },
    { text: "se", duration: 0.78, begin: 218.15, index: 514 },
    { text: " le", duration: 0.78, begin: 218.25, index: 515 },
    { text: "ri", duration: 0.78, begin: 218.5, index: 516 },
    { text: "ni", duration: 0.78, begin: 218.75, index: 517 },
    { text: " i", duration: 0.78, begin: 219.85, index: 518 },
    { text: "yi", duration: 0.78, begin: 219.99, index: 519 },
    { text: " pa", duration: 0.78, begin: 220.25, index: 520 },
    { text: "ra", duration: 0.78, begin: 220.75, index: 521 },
    { text: "ya", duration: 0.78, begin: 220.99, index: 522 },
    { text: " sa", duration: 0.78, begin: 221.25, index: 523 },
    { text: "tar", duration: 0.78, begin: 221.5, index: 524 },
    { text: "sın,", duration: 0.78, begin: 221.75, index: 525 },
    { text: " kı", duration: 0.78, begin: 223.25, index: 526 },
    { text: "sa", duration: 0.78, begin: 223.5, index: 527 },
    { text: " za", duration: 0.78, begin: 223.75, index: 528 },
    { text: "man", duration: 0.78, begin: 223.99, index: 529 },
    { text: "da", duration: 0.78, begin: 224.25, index: 530 },
    { text: " zen", duration: 0.58, begin: 226.0, index: 531 },
    { text: "gin", duration: 0.78, begin: 226.25, index: 532 },
    { text: " o", duration: 0.78, begin: 226.5, index: 533 },
    { text: "lup", duration: 0.78, begin: 226.75, index: 534 },
    { text: " mil", duration: 0.78, begin: 227.85, index: 535 },
    { text: "yon", duration: 0.78, begin: 228.2, index: 536 },
    { text: "lar", duration: 0.78, begin: 228.75, index: 537 },
    { text: " ka", duration: 0.78, begin: 228.99, index: 538 },
    { text: "za", duration: 0.78, begin: 229.25, index: 539 },
    { text: "nır", duration: 0.78, begin: 229.5, index: 540 },
    { text: "sın.", duration: 0.78, begin: 229.75, index: 541 },
    { text: " Mil", duration: 0.78, begin: 231.25, index: 542 },
    { text: "yon", duration: 0.78, begin: 231.5, index: 543 },
    { text: "lar", duration: 0.78, begin: 231.75, index: 544 },
    { text: " ha,", duration: 0.78, begin: 231.99, index: 545 },
    { text: " di", duration: 0.58, begin: 233.45, index: 546 },
    { text: "ye", duration: 0.78, begin: 233.5, index: 547 },
    { text: " tek", duration: 0.78, begin: 233.99, index: 548 },
    { text: "rar", duration: 0.78, begin: 234.2, index: 549 },
    { text: "la", duration: 0.78, begin: 234.5, index: 550 },
    { text: "mış", duration: 0.78, begin: 234.75, index: 551 },
    { text: " ba", duration: 0.78, begin: 235.25, index: 552 },
    { text: "lık", duration: 0.78, begin: 235.5, index: 553 },
    { text: "çı.", duration: 0.78, begin: 235.75, index: 554 },
    { text: " Eeee....", duration: 0.98, begin: 236.5, index: 555 },
    { text: " son", duration: 0.78, begin: 237.99, index: 556 },
    { text: "ra?", duration: 0.78, begin: 238.25, index: 557 },
    { text: " Son", duration: 0.78, begin: 239.75, index: 558 },
    { text: "ra", duration: 0.83, begin: 239.99, index: 559 },
    { text: " e", duration: 0.83, begin: 240.25, index: 560 },
    { text: "mek", duration: 0.83, begin: 240.5, index: 561 },
    { text: "li", duration: 0.83, begin: 240.75, index: 562 },
    { text: " o", duration: 0.83, begin: 240.99, index: 563 },
    { text: "lur", duration: 0.83, begin: 241.25, index: 564 },
    { text: "sun.", duration: 0.78, begin: 241.5, index: 565 },
    { text: " Kü", duration: 0.78, begin: 243.25, index: 566 },
    { text: "çük", duration: 0.78, begin: 243.5, index: 567 },
    { text: " bir", duration: 0.83, begin: 243.75, index: 568 },
    { text: " ba", duration: 0.78, begin: 244.25, index: 569 },
    { text: "lık", duration: 0.78, begin: 244.35, index: 570 },
    { text: "çı", duration: 0.78, begin: 244.5, index: 571 },
    { text: " ka", duration: 0.83, begin: 244.85, index: 572 },
    { text: "sa", duration: 0.78, begin: 245.25, index: 573 },
    { text: "ba", duration: 0.78, begin: 245.5, index: 574 },
    { text: "sı", duration: 0.78, begin: 245.8, index: 575 },
    { text: "na", duration: 0.78, begin: 246.0, index: 576 },
    { text: " yer", duration: 0.83, begin: 246.25, index: 577 },
    { text: "le", duration: 0.83, begin: 246.5, index: 578 },
    { text: "şir", duration: 0.83, begin: 246.75, index: 579 },
    { text: "sin.", duration: 0.83, begin: 246.85, index: 580 },
    { text: " İs", duration: 0.53, begin: 249.5, index: 581 },
    { text: "ter", duration: 0.78, begin: 249.55, index: 582 },
    { text: "sen", duration: 0.78, begin: 249.7, index: 583 },
    { text: " zevk", duration: 0.78, begin: 251.1, index: 584 },
    { text: " i", duration: 0.78, begin: 251.35, index: 585 },
    { text: "çin", duration: 0.78, begin: 251.9, index: 586 },
    { text: " ba", duration: 0.78, begin: 252.35, index: 587 },
    { text: "lık", duration: 0.78, begin: 252.55, index: 588 },
    { text: " tu", duration: 0.78, begin: 252.8, index: 589 },
    { text: "tar", duration: 0.78, begin: 252.9, index: 590 },
    { text: "sın.", duration: 0.78, begin: 253.15, index: 591 },
    { text: " Ço", duration: 0.53, begin: 255.15, index: 592 },
    { text: "cuk", duration: 0.78, begin: 255.25, index: 593 },
    { text: "la", duration: 0.78, begin: 255.55, index: 594 },
    { text: "rın", duration: 0.78, begin: 255.808, index: 595 },
    { text: "la", duration: 0.78, begin: 256.15, index: 596 },
    { text: " oy", duration: 0.78, begin: 256.35, index: 597 },
    { text: "nar,", duration: 0.78, begin: 256.55, index: 598 },
    { text: " ka", duration: 0.53, begin: 258.35, index: 599 },
    { text: "rın", duration: 0.78, begin: 258.45, index: 600 },
    { text: "la", duration: 0.78, begin: 258.8, index: 601 },
    { text: " key", duration: 0.68, begin: 259.85, index: 602 },
    { text: "fin", duration: 0.78, begin: 259.99, index: 603 },
    { text: "ce", duration: 0.78, begin: 260.15, index: 604 },
    { text: " si", duration: 0.98, begin: 260.35, index: 605 },
    { text: "es", duration: 0.98, begin: 260.55, index: 606 },
    { text: "ta", duration: 0.98, begin: 260.85, index: 607 },
    { text: " ya", duration: 0.98, begin: 260.99, index: 608 },
    { text: "par", duration: 0.98, begin: 261.15, index: 609 },
    { text: "sın.", duration: 0.98, begin: 261.35, index: 610 },
    { text: " Ak", duration: 0.78, begin: 263.8, index: 611 },
    { text: "şam", duration: 0.83, begin: 264.1, index: 612 },
    { text: "la", duration: 0.83, begin: 264.35, index: 613 },
    { text: "rı", duration: 0.83, begin: 264.55, index: 614 },
    { text: "da", duration: 0.83, begin: 264.85, index: 615 },
    { text: " ar", duration: 0.78, begin: 266.8, index: 616 },
    { text: "ka", duration: 0.78, begin: 266.9, index: 617 },
    { text: "daş", duration: 0.78, begin: 267.25, index: 618 },
    { text: "la", duration: 0.78, begin: 267.55, index: 619 },
    { text: "rın", duration: 0.78, begin: 267.85, index: 620 },
    { text: "la", duration: 0.78, begin: 267.99, index: 621 },
    { text: " şa", duration: 0.53, begin: 269.35, index: 622 },
    { text: "rap", duration: 0.78, begin: 269.45, index: 623 },
    { text: " i", duration: 0.78, begin: 269.65, index: 624 },
    { text: "çip", duration: 0.78, begin: 269.85, index: 625 },
    { text: " ge", duration: 0.53, begin: 271.25, index: 626 },
    { text: "ce", duration: 0.78, begin: 271.3, index: 627 },
    { text: " ya", duration: 0.78, begin: 271.75, index: 628 },
    { text: "rı", duration: 0.78, begin: 271.95, index: 629 },
    { text: "sı", duration: 0.78, begin: 272.15, index: 630 },
    { text: "na", duration: 0.78, begin: 272.35, index: 631 },
    { text: " ka", duration: 0.78, begin: 272.75, index: 632 },
    { text: "dar", duration: 0.78, begin: 272.95, index: 633 },
    { text: " gi", duration: 0.78, begin: 273.35, index: 634 },
    { text: "tar", duration: 0.78, begin: 273.55, index: 635 },
    { text: " ça", duration: 0.78, begin: 273.75, index: 636 },
    { text: "lar", duration: 0.78, begin: 273.99, index: 637 },
    { text: "sın.", duration: 0.78, begin: 274.2, index: 638 },
  ];
        ...
        <div className="max-w-7x1 mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-5">
              <Link
                href="/dashboard/stories/kir-zincilerini"
